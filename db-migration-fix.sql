-- Database Migration Fix for GitHub/Render Deployment
-- Ensures all instructor columns exist with proper data types

-- Add email column if it doesn't exist (for fresh deployments)
ALTER TABLE instructors ADD COLUMN IF NOT EXISTS email text;

-- Add all extended instructor fields if they don't exist
