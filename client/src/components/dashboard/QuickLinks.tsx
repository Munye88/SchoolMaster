...
const QuickLinks: React.FC = () => {
  return (
    <div className="bg-white rounded-xl shadow-sm border-[1px] border-gray-100 p-3">
      <h2 className="text-[#0B1D51] text-lg font-semibold mb-3">Quick Links</h2>
      
      {/* Instructor Lookup Link */}
      <Link href="/instructor-lookup">
        <div className="flex items-center justify-between py-3 cursor-pointer hover:bg-gray-50 transition-colors">
          <div className="flex items-center">
            ...
            <span className="text-[#0B1D51] text-base font-medium">Instructor Lookup</span>
          </div>
      ...
      <Link href="/courses">
        <div className="flex items-center justify-between py-3 cursor-pointer hover:bg-gray-50 transition-colors">
          <div className="flex items-center">
            ...
            <span className="text-[#0B1D51] text-base font-medium">Course Management</span>
          </div>
          <ChevronRight className="h-4 w-4 text-gray-400" />
        </div>
      </Link>
