...
// School data matching the screenshot
const schoolData = [
  {
    id: 349,
    name: 'KFNA',
...
const BookInventory = () => {
  return (
    <div className="container py-8">
      <h1 className="text-3xl font-bold text-[#0B1D51] mb-2">DLI Book Inventory Management</h1>
      <p className="text-gray-600 mb-6">Track and manage book inventory across all schools</p>
        ...
        {schoolData.map(school => (
          ...
          >
            <div className="p-6">
              ...
              <div className="text-sm text-gray-500 mb-1">Book Inventory</div>
              <div className="text-5xl font-bold mb-4">{school.total}</div>
              <div className="text-sm text-gray-500 mb-3">Total Books</div>
              ...
              <Link href={`/dli/book-inventory/${school.code.toLowerCase()}`}>
                <Button 
