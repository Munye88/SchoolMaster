              ...
              <CardContent className="h-80 bg-gradient-to-b from-blue-50 to-white py-3 px-1">
                <div className="w-full h-full rounded-lg bg-white shadow-inner p-4">
                  <div className="w-full h-full relative">
                    ...
                    {/* Text labels positioned exactly as in screenshot */}
                    <div className="absolute top-[30%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-base font-medium text-center">
                      <span className="text-[#0A2463]">PTO: 28 (39%)</span>
                    </div>
                    
                    <div className="absolute top-1/2 left-[25%] transform -translate-x-1/2 -translate-y-1/2 text-base font-medium">
                      <span className="text-[#3B82F6]">R&R: 20 (28%)</span>
                    </div>
                    
                    <div className="absolute bottom-[30%] left-[30%] transform -translate-x-1/2 text-base font-medium">
                      <span className="text-[#4CB944]">Paternity: 12 (17%)</span>
                    </div>
                    
                    <div className="absolute bottom-[30%] right-[25%] transform translate-x-1/2 text-base font-medium">
                      <span className="text-[#FF8811]">Bereavement: 8 (11%)</span>
                    </div>
                    
                    <div className="absolute top-1/2 right-[20%] transform translate-x-1/2 -translate-y-1/2 text-base font-medium">
                      <span className="text-[#E63946]">Negative PTO: 4 (6%)</span>
                    </div>
                  </div>
                </div>
              </CardContent>
