...
import { Download, FileText, Share2, Printer, Info } from "lucide-react";

const SchoolStudentDaySchedule = () => {
  const { currentSchool } = useSchool();
  
  // Check if the current school is NFS East (code check)
  const isNFSEast = currentSchool?.code === "NFS East";
      ...
      {!isNFSEast ? (
        <Card>
          ...
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium mb-2">School-Specific Information</h3>
            <p className="text-center text-gray-500 max-w-md">
              The Student Day Schedule is only available for NFS East. 
              Please select NFS East from the sidebar to view the schedule.
            </p>
          </CardContent>
        </Card>
      ) : (
