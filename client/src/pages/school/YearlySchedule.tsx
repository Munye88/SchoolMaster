      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-16">
            <h3 className="text-lg font-medium text-gray-500 mb-4">Yearly schedule will be populated from PowerBI</h3>
            <p className="text-sm text-gray-400 max-w-md mx-auto">
              Connect your Excel sheets with yearly schedule data to populate this section with the annual academic calendar.
            </p>
